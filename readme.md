...
This repository contains the AbstractGsplatNerf tool for neural rendering and robust analysis.  
...
### 1. Clone the AbstractGsplatNerf repository

Download the repository from GitHub:

```bash
cd ~
git clone https://github.com/Chenxi-Ji/AbstractGsplatNerf.git
```
...
From the root folder of *AbstractGsplatNerf*, create a soft link to the auto_LiRPA folder:

```bash
cd ~/AbstractGsplatNerf
...
Replace the folder *nerfstudio* under the root folder of *AbstractGsplatNerf* with the downloaded dataset:
